...
def unique_network_map(topology_dict):
    ...
    for key, value in topology_dict.items():
        if not unique_topology_dict.get(value) == key:
...
if __name__ == "__main__":
    ...
    # print("\n")
    unique_topology_dict = unique_network_map(topology_dict)
    # pprint(unique_topology_dict)

    draw_topology(unique_topology_dict, output_filename = "img/topology_02.svg")